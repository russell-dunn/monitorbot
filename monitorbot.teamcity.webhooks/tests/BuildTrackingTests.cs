...
namespace monitorbot.teamcity.webhooks.tests
{
    class BuildTrackingTests
    {
        ...
        public void PostsResponseIfTrackingBranchBreakage()
        {
            ...
            var teamcityEvent = new TeamcityEvent(TeamcityEventType.Unknown, "build-id", "buildType", "build name", BuildResultDelta.Broken, "master", TeamcityBuildState.Unknown, "", "1.0");
