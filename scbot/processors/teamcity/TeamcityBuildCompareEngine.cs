    ...
    class TeamcityBuildCompareEngine
    {
        ...
        internal IEnumerable<Response> CompareBuildStates(IEnumerable<Update<TeamcityBuildStatus>> comparison)
        {
            ...
            foreach (var diff in differences)
            {
                ...
                m_Persistence.RemoveFromList(c_PersistenceKey, x => x.Build.Id == id);
                m_Persistence.AddToList(c_PersistenceKey, new TrackedTeamcityBuild(diff.update.NewValue, diff.update.Channel));
